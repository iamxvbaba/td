...
issue history remain at [gotd/td](https://github.com/gotd/td).
...
```console
go get github.com/iamxvbaba/td
```
...
* Full MTProto 2.0 implementation in Golang, directly access any MTProto method with [telegram.Client.API()](https://pkg.go.dev/github.com/iamxvbaba/td/telegram#Client.API)
* Voice and video [calls](https://pkg.go.dev/github.com/iamxvbaba/td/telegram/calls) (tgcalls), both 1:1 and group calls — see the [call](examples/call) and [groupcall](examples/groupcall) examples
...
* Various helpers that lighten the complexity of the Telegram API
  * [uploads](https://pkg.go.dev/github.com/iamxvbaba/td/telegram/uploader) for big and small files with multiple streams for single file and progress reporting
  * [downloads](https://pkg.go.dev/github.com/iamxvbaba/td/telegram/downloader) with CDN support, also multiple streams
  * [messages](https://pkg.go.dev/github.com/iamxvbaba/td/telegram/message) with various convenience builders and text styling support
  * [query](https://pkg.go.dev/github.com/iamxvbaba/td/telegram/query) with pagination helpers
  * [middleware](https://pkg.go.dev/github.com/iamxvbaba/td/telegram#Middleware) for [rate limiting](https://pkg.go.dev/github.com/gotd/contrib/middleware/ratelimit) and [FLOOD_WAIT handling](https://pkg.go.dev/github.com/gotd/contrib/middleware/floodwait)
* Connection pooling
